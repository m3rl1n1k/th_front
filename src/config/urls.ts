...
export const URLS = {
  ...
  transactionFrequencies: `${API_BASE_URL}/transactions/frequency`, // GET -> { periods: { [id: string]: name: string } }
  transactionCategories: `${API_BASE_URL}/transactions/categories`, // GET -> { categories: { [id: string]: name: string } } (Placeholder)
  ...
  // Wallets
  wallets: `${API_BASE_URL}/wallets`, // GET -> { wallets: WalletDetails[] }
  walletTypes: `${API_BASE_URL}/wallets/types`, // GET -> { types: { [key: string]: string } }
};
