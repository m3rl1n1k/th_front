  ...
  return (
    <Card className="mb-6 p-4 shadow-lg">
      <CardHeader className="p-2 pb-4">
        <CardTitle className="text-lg font-headline">{translations.filterTitle || 'Filter Transactions'}</CardTitle>
      </CardHeader>
      <CardContent className="p-2 space-y-4 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <div className="space-y-1">
          ...
          <Select value={walletId} onValueChange={setWalletId}>
            <SelectTrigger id="filter-wallet">
        ...
        <div className="flex items-end space-x-2 col-span-full md:col-span-1 xl:col-span-2">
          <Button onClick={handleApply} className="w-full sm:w-auto">{translations.applyButton || 'Apply Filters'}</Button>
